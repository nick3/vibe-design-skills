...
This repository contains original Skill instructions, templates, schemas, and validation tooling. It does not vendor source code, model weights, visual assets, or product-specific design values from the projects listed below.

The work is informed by and cites:

- [Alibaba Cloud Design — Vibe Designing Playbook](https://alibaba-cloud-design.github.io/vibe-designing-playbook/) for Design I/O, declarations and execution contracts, evidence-based evaluation, Agentic UX/GenUI/A2UI boundaries, and governed learning concepts.
- [Google Labs — `design.md`](https://github.com/google-labs-code/design.md) for the interoperable `DESIGN.md` document format and tooling expectations.
